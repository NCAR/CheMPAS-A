...
- Adapt the User's Guide for CheMPAS-A 26.04, based on MPAS-Atmosphere v8.3.1.
- Add CheMPAS-A runtime chemistry tracer and MUSICA/MICM/TUV-x coupling chapters.
- Update build guidance for current precision defaults, MUSICA builds, and local preflight tooling.

Entries below this point are retained from the upstream MPAS-A User's Guide history; they may refer to appendices or figures that are not included in this CheMPAS-A port.
